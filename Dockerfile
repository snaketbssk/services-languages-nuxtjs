# docker build -t snaketbs/serviceslanguages .
# docker push snaketbs/serviceslanguages
# docker run -p 3000:3000 -e "NODE_OPTIONS=--openssl-legacy-provider" snaketbs/serviceslanguages
